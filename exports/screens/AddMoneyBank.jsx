/* =========================================================================
   Money Market Fund — Mobile App · Screen: AddMoneyBank
...
const AddMoneyBank = () => {
  ...
  const [allCopied, setAllCopied] = useStateW(false);
  const AMOUNT = 500000;
  const REF = 'MMF-200001281';

  const fields = [
    { key:'bank',   l:'Хүлээн авах банк',  v:'Хаан Банк'             },
    { key:'acct',   l:'Дансны дугаар',      v:'5041 28100 1281'       },
  ...
  const tapAll = () => {
    setCopiedKey('all'); setAllCopied(true);
    setTimeout(() => { setCopiedKey(null); setAllCopied(false); }, 2000);
  };

  const CopyBtn = ({ fkey }) => {
    const done = copiedKey === fkey || copiedKey === 'all';
    return (
      <button onClick={() => tap(fkey)} style={{
  ...
  return (
    <FrameW label="W2b — Орлого · Дансаар шилжүүлэх">
      ...
      <WFooter
        onSecondary={tapAll}
        secondary={allCopied ? '✓ Бүгд хуулагдлаа' : 'Бүгдийг хуулах'}
      >
...
(window.__MMF_SCREENS = window.__MMF_SCREENS || {}).AddMoneyBank = AddMoneyBank;
})();